...
def tr_augmentation(KEYS, in_size, out_size, crop_center):
    return Compose([
        ...
        RandFlipd(keys = KEYS, prob = 0.2, spatial_axis = 0, allow_missing_keys = True),
        RandFlipd(keys = KEYS, prob = 0.2, spatial_axis = 1, allow_missing_keys = True),
        RandFlipd(keys = KEYS, prob = 0.2, spatial_axis = 2, allow_missing_keys = True),
