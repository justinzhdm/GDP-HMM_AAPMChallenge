...
# from mednext.nnunet_mednext.network_architecture.mednextv1.MedNextV1 import MedNeXt_dose
# def create_mednextv1_dose(num_input_channels, num_classes, kernel_size=3, ds=False):
#         return MedNeXt_dose(
#             in_channels=num_input_channels,
#             n_channels=32,
#             n_classes=num_classes,
...
from mednext.nnunet_mednext.network_architecture.mednextv1.MedNextV1_mi import MedNeXt_mi
def create_mednext_mi(num_input_channels, num_classes, model_id, kernel_size=3, deep_supervision=False):
    return MedNeXt_mi(
        in_channels = num_input_channels,
        n_channels = 32,
        n_classes = num_classes,
